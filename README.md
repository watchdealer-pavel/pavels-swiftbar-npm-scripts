...
2. 2. Clone this repo to your SwiftBar plugins folder
   3. 3. Edit `npm-dev-server.1m.sh` and set your project path
      4. 4. Make scripts executable: `chmod +x *.sh`
         5. 5. Reload SwiftBar
           
            6. ## Setup
           
            7. Edit the main plugin file and change this line:
